        ...
        try {
            switch (dataType) {
                ...
                case "manufacturing_process" -> {
                    List<ManufacturingProcess> manufacturingProcessList = mapper.readValue(dataArray.traverse(),
                            new TypeReference<>() {
                            });
                ...
                case "material_master" -> {
                    List<MaterialMaster> materialMasterList = mapper.readValue(dataArray.traverse(),
                            new TypeReference<>() {
                            });
                ...
                case "operation" -> {
                    List<Operation> operationList = mapper.readValue(dataArray.traverse(),
                            new TypeReference<>() {
                            });
                ...
                case "operation_sequence" -> {
                    List<OperationSequence> operationSequenceList = mapper.readValue(dataArray.traverse(),
                            new TypeReference<>() {
                            });
                ...
                case "plant_master" -> {
                    List<PlantMaster> plantMasterList = mapper.readValue(dataArray.traverse(),
                            new TypeReference<>() {
                            });
                ...
                case "priority" -> {
                    List<Priority> priorityList = mapper.readValue(dataArray.traverse(),
                            new TypeReference<>() {
                            });
                ...
                case "sales_order" -> {
                    List<SalesOrder> salesOrderList = mapper.readValue(dataArray.traverse(),
                            new TypeReference<>() {
                            });
                ...
                case "tool_map" -> {
                    List<ToolMap> toolMapList = mapper.readValue(dataArray.traverse(),
                            new TypeReference<>() {
                            });
                ...
                case "tool_master" -> {
                    List<ToolMaster> toolMasterList = mapper.readValue(dataArray.traverse(),
                            new TypeReference<>() {
                            });
                ...
                case "workcenter_map" -> {
                    List<WorkcenterMap> workcenterMapList = mapper.readValue(dataArray.traverse(),
                            new TypeReference<>() {
                            });
                ...
                case "workcenter_master" -> {
                    List<WorkcenterMaster> workcenterMasterList = mapper.readValue(dataArray.traverse(),
                            new TypeReference<>() {
                            });
